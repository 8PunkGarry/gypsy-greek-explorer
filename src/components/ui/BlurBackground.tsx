...
const BlurBackground: React.FC<BlurBackgroundProps> = ({ className }) => {
  return (
    <div className={`fixed inset-0 pointer-events-none ${className}`}>
      ...
      <div className="absolute top-[40%] left-[30%] w-[20%] h-[20%] bg-cyan-300/5 rounded-full blur-[80px] animate-float" style={{ animationDelay: '4s' }} />
      <div className="absolute top-[20%] right-[30%] w-[15%] h-[15%] bg-purple-300/5 rounded-full blur-[60px] animate-float" style={{ animationDelay: '6s' }} />
    </div>
  );
};
