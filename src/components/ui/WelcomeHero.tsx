  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center py-16 overflow-hidden">
      <div className="container mx-auto px-4 text-center z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 max-w-4xl mx-auto leading-tight animate-scale-in" style={{
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-10 animate-fade-in" style={{
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{
          ...
          {isAuthenticated ? (
            <Button 
              className="px-8 py-6 bg-blue-600/90 text-white rounded-md text-lg font-medium shadow-md hover:bg-blue-700 transition-all duration-300" 
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 bg-[#2A3441]/80 p-6 rounded-lg border border-gray-700/30">
              <div className="text-gray-300 text-lg">
                ...
                <p className="mb-4 text-gray-400">{t('saveProgress')}</p>
                <UserAuthDialog />
              </div>
            </div>
          )}
